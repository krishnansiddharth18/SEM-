...
parser.add_argument('--sel', type=str,default="protein or resname PHPC",
...
try:
        ...
        print(f"Arguments successfully saved to")
...
def _get_grids():
    ...
    min_= np.array((-40,-40,-34)) #box min
    max_ = np.array((40,40,34)) #box max
    resolution=1
